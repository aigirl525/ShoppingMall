package com.luowj.shoppingmall.utils;

/**
 * Created by hasee on 2017/2/14.
 */
public class Constants {
    public static final String BASE = "http://192.168.2.116:8080";
    //请求Ison数据基本URL
...
//文具
public static final String STATIONERY_URL = Base_URL_JSON +
        "STATIONERY_URL.json";
    ...
    //cosplay
    public static final String COSPLAY_STORE = Base_URL_JSON +
            "COSPLAY_STORE.json";
    //古风仓
